...
class SpacingComponent extends React.Component {
  ...
  onPropertyChange(direction, name, value) {
    ...
    if ( opositeProp !== '' ) {
      properties = {...properties, [opositeProp]: {...style[opositeProp], value} }
    }
  ...
  render() {
    ...
    let { paddingLeft, paddingRight, paddingTop, paddingBottom, marginLeft, marginRight, marginTop, marginBottom } = style;
    let { paddingLock, marginLock } = this.state;
    ...
    return (
      <div className="editor-x-spacing-panel">
        ...
        <div className="editor-x-spacing-wrap">
          ...
          >
              <div className="editor-x-spacing-value">{marginLeft.value || 0}</div>
              <span className={`fas ${marginLock === 'V' ? 'fa-unlink': 'fa-link'} editor-x-link-icon`} onClick={()=>this.onMarginLock('V')}></span>
          </SpaceBox>
          ...
          >
              ...
              <span className={`fas ${marginLock === 'H' ? 'fa-unlink': 'fa-link'} editor-x-link-icon`}  onClick={()=>this.onMarginLock('H')}></span>
          </SpaceBox>
          ...
          >
              <div className="editor-x-spacing-value">{marginBottom.value || 0}</div>
              <span className={`fas ${marginLock === 'H' ? 'fa-unlink': 'fa-link'} editor-x-link-icon`}  onClick={()=>this.onMarginLock('V')}></span>
          </SpaceBox>
          ...
          >
              <div className="editor-x-spacing-value">{marginRight.value || 0}</div>
              <span className={`fas ${marginLock === 'V' ? 'fa-unlink': 'fa-link'} editor-x-link-icon`}  onClick={()=>this.onMarginLock('H')}></span>
          </SpaceBox>
          ...
          <div className="editor-x-padding-wrap">
            ...
            >
                <div className="editor-x-spacing-value">{paddingLeft.value || 0}</div>
                <span className={`fas ${paddingLock === 'V' ? 'fa-unlink': 'fa-link'} editor-x-link-icon`}  onClick={()=>this.onPaddingLock('V')}></span>
            </SpaceBox>
            <SpaceBox
            ...
            >
                <div className="editor-x-spacing-value">{paddingTop.value || 0}</div>
                <span className={`fas ${paddingLock === 'H' ? 'fa-unlink': 'fa-link'} editor-x-link-icon`}  onClick={()=>this.onPaddingLock('H')}></span>
            </SpaceBox>
            ...
            >
                <div className="editor-x-spacing-value">{paddingBottom.value || 0}</div>
                <span className={`fas ${paddingLock === 'H' ? 'fa-unlink': 'fa-link'} editor-x-link-icon`}  onClick={()=>this.onPaddingLock('H')}></span>
            </SpaceBox>
            <SpaceBox
            ...
            >
                <div className="editor-x-spacing-value">{paddingRight.value || 0}</div>
                <span className={`fas ${paddingLock === 'V' ? 'fa-unlink': 'fa-link'} editor-x-link-icon`}  onClick={()=>this.onPaddingLock('V')}></span>
            </SpaceBox>
