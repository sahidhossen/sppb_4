      ...
      <div className="editor-x-navigator">
        ...
        >
          ...
          <div className="editor-x-navigator-content">
            ...
            <span className="editor-x-navigator-text">Hero section</span>
          </div>
        ...
        >
          ...
          <div className="editor-x-navigator-content">
            ...
            <span className="editor-x-navigator-hash">#</span>
            <span className="editor-x-navigator-text">Container</span>
          </div>
          <span className="fas fa-ellipsis-h editor-x-navigator-dot-btn"></span>
        </div>
        <div
        ...
        >
          ...
          <div className="editor-x-navigator-content">
            ...
            <span className="editor-x-navigator-hash">#</span>
            <span className="editor-x-navigator-text">Hero Grid</span>
          </div>
          <span className="fas fa-ellipsis-h editor-x-navigator-dot-btn"></span>
        </div>
        <div
        ...
        >
          ...
          <div className="editor-x-navigator-content">
            ...
            <span className="editor-x-navigator-hash">#</span>
            <span className="editor-x-navigator-text">Left Hero Block</span>
          </div>
          <span className="fas fa-ellipsis-h editor-x-navigator-dot-btn"></span>
        </div>
        <div
        ...
        >
          ...
          <div className="editor-x-navigator-content">
            ...
            <span className="editor-x-navigator-hash">#</span>
            <span className="editor-x-navigator-text">H1 Hero Title</span>
          </div>
          <span className="fas fa-ellipsis-h editor-x-navigator-dot-btn"></span>
        </div>
        <div
        ...
        >
          ...
          <div className="editor-x-navigator-content">
            ...
            <span className="editor-x-navigator-hash">#</span>
            <span className="editor-x-navigator-text">P Hero Paragraph</span>
          </div>
          <span className="fas fa-ellipsis-h editor-x-navigator-dot-btn"></span>
        </div>
        <div
        ...
        >
          ...
          <div className="editor-x-navigator-content">
            ...
            <span className="editor-x-navigator-hash">#</span>
            <span className="editor-x-navigator-text">Clients section</span>
          </div>
          <span className="fas fa-ellipsis-h editor-x-navigator-dot-btn"></span>
        </div>
