const initialControls = {
  ...
  dockerPalet: {
    navigator: "navigator", // Navigator, bookmark, addonlist
...
const builderControl = (state = initialControls, action) => {
  switch (action.type) {
    ...
    case "SET_SIDEBAR": {
      const {
        payload: { sidebarName = "leftSidebar", settings },
      } = action;
    ...
    case "UPDATE_ACTIVE_MEDIA_QUERY": {
      ...
      if (!mediaQuery.list[name]) return state;
